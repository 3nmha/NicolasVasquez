...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapterr = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, UbicacionS);
        Ubicacion.setAdapter(adapterr);
    ...
    public void RegistrarProducto(View view){
        ...
        String UbicacionS = Ubicacion.getSelectedItem().toString();
        if (!IDproducto.isEmpty() || !NombreProducto.isEmpty() || !CategoriaS.equals("Seleccionar:") || !cantidad.equals("") || !precio.equals("") || !UbicacionS.equals("Seleccionar:")){
            ...
            DatosUsuario.put("UbicacionProducto", UbicacionS);
    ...
    public void EliminarProducto(View view){
        ...
        SQLiteDatabase BaseDatos = admin.getWritableDatabase();
        String IDProducto = ID.getText().toString();
        Cursor fila = BaseDatos.rawQuery("DELETE NombreProducto, CategoriaProducto, CantidadProducto, PrecioProducto," +
                " UbicacionProducto FROM Inventario_Bodega WHERE ID =" + IDProducto, null);
        ...
        if (!IDProducto.isEmpty()){
            ...
            Toast.makeText(this, "Campo ID no puede estar vacio", Toast.LENGTH_LONG).show();
            BaseDatos.close();
        }
    ...
    public void ModificarProducto(View view){
        ...
        if (!IDproducto.isEmpty() && !NombreProducto.isEmpty() && !CategoriaS.equals("Seleccionar:") && !cantidad.equals("") && !precio.equals("") && !ubicacion.equals("Seleccionar:")){
            ContentValues DatosUsuario = new ContentValues();
            DatosUsuario.put("ID", IDproducto);
            DatosUsuario.put("NombreProducto", NombreProducto);
            DatosUsuario.put("CategoriaProducto", CategoriaS);
